...
def ssDeact_analyse_CD_neg_50mV_neg_120mV_peak_ratio(input_file, wellID, result_plots, num_sweeps, variant, sweep_length, total_sweeps, neg_50_amp_thresh, neg_120_amp_thresh):
    # TO DO:
    # Pass
