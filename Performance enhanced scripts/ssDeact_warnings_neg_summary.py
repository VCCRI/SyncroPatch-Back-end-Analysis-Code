...
def generate_neg_summary_warnings(A_fast,A_slow ,tau_fast,tau_slow,actual_sweep,summary_sweep,sweep_length,min_model,rsquare,rsq_thresh,amp_thresh, summary_sweep_voltage, sweep_voltage):
    warning = ''
                ...
                if tau_fast * 1e-3 <= sweep_length:
                    if tau_slow * 1e-3 <= sweep_length:
                        if min_model <= amp_thresh:
                            ...
                            if A_fast < 0:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both amplitudes negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both amplitudes negative'
                                else:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_fast amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_fast amplitude negative'
                            else:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_slow amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_slow amplitude negative'
                                else:
                                    if A_fast > 2000:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both amplitudes too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both amplitudes too high'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_fast amplitude too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_fast amplitude too high'
                                    else:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_slow amplitude too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_slow amplitude too high'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor'
                    else:
                        if min_model <= amp_thresh:
                            if A_fast < 0:
                                if A_slow < 0:
                            ...
                            if A_fast < 0:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes are negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes are negative'
                                else:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude negative'
                            else:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude negative'
                                else:
                                    if A_fast > 2000:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes too high'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude too high'
                                    else:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude too high'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration'
                else:
                    if tau_slow * 1e-3 > sweep_length:
                        if min_model <= amp_thresh:
                            if A_fast < 0:
                            ...
                            if A_fast < 0:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and both amplitudes negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and both amplitudes negative'

                                else:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude negative'
                            else:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude negative'
                                else:
                                    if A_fast > 2000:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and both amplitudes too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and both amplitudes too hogh'

                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude to high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude too high'
                                    else:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude too high'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration'
                    else:
                        if min_model <= amp_thresh:
                            if A_fast < 0:
                                if A_slow < 0:
                            ...
                            if A_fast < 0:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and both amplitudes negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and both amplitudes negative'
                                else:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude negative'
                            else:
                                if A_slow < 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude negative'
                                else:
                                    if A_fast > 2000:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and both amplitudes too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and both amplitudes too high'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude too high'
                                    else:
                                        if A_slow > 2000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude too high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude too high'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration'
            else:
                if tau_fast < 0:
                    if tau_slow > 0:
                        if A_fast < 0:
                            if A_slow < 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes negative'
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude negative'
                        else:
                            if A_slow < 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude negative'
                            else:
                                if A_fast > 2000:
                                    if A_slow > 2000:
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes too high'
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude too high'
                                else:
                                    if A_slow > 2000:
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude too high'
                                    else:
                                        warning = 'tau_fast negative'
                                        if rsquare < rsq_thresh:
                                            warning = 'tau_fast negative and Rsquare below supplied threshold'
                                            if min_model > amp_thresh:
                                                warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low'
                    else:
                        if A_fast < 0:
                            if A_slow < 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes are negative'
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude negative'
                            ...
                            if A_slow < 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude negative'
                                ...
                                if A_fast > 2000:
                                    if A_slow > 2000:
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes are too high'
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude are too high'
                                else:
                                    if A_slow > 2000:
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude too high'
                                    else:
                                        warning = 'tau values are both negative'
                                        if rsquare < rsq_thresh:
                                            warning = 'both tau values are negative and Rsquare below supplied threshold'
                                            if min_model > amp_thresh:
                                                warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low'
                else:
                    if A_fast < 0:
                        if A_slow < 0:
                            ...
                            if rsquare < rsq_thresh:
                                ...
                                if min_model > amp_thresh:
                                    warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes are negative'
                        else:
                            ...
                            if rsquare < rsq_thresh:
                                ...
                                if min_model > amp_thresh:
                                    warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude negative'
                    else:
                        if A_slow < 0:
                            ...
                            if rsquare < rsq_thresh:
                                ...
                                if min_model > amp_thresh:
                                    warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude negative'
                        else:
                            if A_fast > 2000:
                                if A_slow > 2000:
                                    ...
                                    if rsquare < rsq_thresh:
                                        ...
                                        if min_model > amp_thresh:
                                            warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes too high'
                                else:
                                    ...
                                    if rsquare < rsq_thresh:
                                        ...
                                        if min_model > amp_thresh:
                                            warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude too high'
                            else:
                                if A_slow > 2000:
                                    ...
                                    if rsquare < rsq_thresh:
                                        ...
                                        if min_model > amp_thresh:
                                            warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude too high'
                                else:
                                    warning = 'tau_slow negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'tau_slow negative and Rsquare below supplied threshold'
                                        if min_model > amp_thresh:
                                            warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low'
                ...
                if tau_fast * 1e-3 <= sweep_length:
                    if tau_slow * 1e-3 <= sweep_length:
                        if min_model <= amp_thresh:
                            ...
                            if A_fast > 0:
                                if A_slow > 0:
                                    ...
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_fast amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_fast amplitude positive'
                            else:
                                if A_slow > 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_slow amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_slow amplitude positive'
                                else:
                                    if A_fast < -10000:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both amplitudes far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both amplitudes far too negative'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_fast amplitude far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_fast amplitude far too negative'
                                    else:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and A_slow amplitude far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and A_slow amplitude far too negative'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor'
                        ...
                        if min_model <= amp_thresh:
                            ...
                            if A_fast > 0:
                                if A_slow > 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes are positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes are positive'
                                else:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude positive'
                            else:
                                if A_slow > 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude positive'
                                else:
                                    if A_fast < -10000:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and both amplitudes far too negative'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_fast amplitude far too negative'
                                    else:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration and A_slow amplitude far too negative'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_slow parameter has taken on a value longer than the sweep duration'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_slow parameter has taken on a value longer than the sweep duration'
                        ...
                        if min_model <= amp_thresh:
                            ...
                            if A_fast > 0:
                                if A_slow > 0:
                                    ...
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude positive'
                            else:
                                if A_slow > 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude positive'
                                else:
                                    if A_fast < -10000:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and both amplitudes far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and both amplitudes too hogh'
                                            ...
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude to high'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_fast amplitude far too negative'
                                    else:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration and A_slow amplitude far too negative'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and both tau parameters have taken on values longer than the sweep duration'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and both tau parameters have taken on values longer than the sweep duration'
                        ...
                        if min_model <= amp_thresh:
                            ...
                            if A_fast > 0:
                                if A_slow > 0:
                                    ...
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude positive'
                            else:
                                if A_slow > 0:
                                    warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude positive'
                                    if rsquare < rsq_thresh:
                                        warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude positive'
                                else:
                                    if A_fast < -10000:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and both amplitudes far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and both amplitudes far too negative'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_fast amplitude far too negative'
                                    else:
                                        if A_slow < -10000:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude far too negative'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration and A_slow amplitude far too negative'
                                        else:
                                            warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and the tau_fast parameter has taken on a value longer than the sweep duration'
                                            if rsquare < rsq_thresh:
                                                warning = 'Minimum current amplitude greater than the appropriate amplitude threshold and Rsquare poor and the tau_fast parameter has taken on a value longer than the sweep duration'
                        ...
                        if A_fast > 0:
                            if A_slow > 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude positive'
                        else:
                            if A_slow > 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude positive'
                            else:
                                if A_fast < -10000:
                                    if A_slow < -10000:
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes far too negative'
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude far too negative'
                                else:
                                    if A_slow < -10000:
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'tau_fast negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude far too negative'
                                    else:
                                        warning = 'tau_fast negative'
                                        if rsquare < rsq_thresh:
                                            warning = 'tau_fast negative and Rsquare below supplied threshold'
                        ...
                        if A_fast > 0:
                            if A_slow > 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes are positive'
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude positive'
                            ...
                            if A_slow > 0:
                                ...
                                if rsquare < rsq_thresh:
                                    ...
                                    if min_model > amp_thresh:
                                        warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude positive'
                                ...
                                if A_fast < -10000:
                                    ...
                                    if A_slow < -10000:
                                        ...
                                        if rsquare < rsq_thresh:
                                            ...
                                            if min_model > amp_thresh:
                                                warning = 'both tau values are negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude far too negative'
                                    else:
                                        warning = 'tau values are both negative'
                                        if rsquare < rsq_thresh:
                                            warning = 'both tau values are negative and Rsquare below supplied threshold'
                    ...
                    if A_fast > 0:
                        if A_slow > 0:
                            ...
                            if rsquare < rsq_thresh:
                                ...
                                if min_model > amp_thresh:
                                    warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes are positive'
                        else:
                            ...
                            if rsquare < rsq_thresh:
                                ...
                                if min_model > amp_thresh:
                                    warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude positive'
                    else:
                        if A_slow > 0:
                            ...
                            if rsquare < rsq_thresh:
                                ...
                                if min_model > amp_thresh:
                                    warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude positive'
                        else:
                            if A_fast < -10000:
                                if A_slow < -10000:
                                    ...
                                    if rsquare < rsq_thresh:
                                        ...
                                        if min_model > amp_thresh:
                                            warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and both amplitudes far too negative'
                                else:
                                    ...
                                    if rsquare < rsq_thresh:
                                        ...
                                        if min_model > amp_thresh:
                                            warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_fast amplitude far too negative'
                            else:
                                if A_slow < -10000:
                                    ...
                                    if rsquare < rsq_thresh:
                                        ...
                                        if min_model > amp_thresh:
                                            warning = 'tau_slow negative, Rsquare below supplied threshold and min current amplitude too low and A_slow amplitude far too negative'
                                else:
                                    warning = 'tau_slow negative'
                                    if rsquare < rsq_thresh:
                                        warning = 'tau_slow negative and Rsquare below supplied threshold'
