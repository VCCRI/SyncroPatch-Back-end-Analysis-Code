...
def ssDeact_analyse_CD_neg_40mV_250ms_500ms_peak_ratio(input_file, wellID, result_plots, num_sweeps, variant, sweep_length, total_sweeps, amp_thresh):
    #print(wellID)
    ...
    for sweep in range(1, (2*num_sweeps), 2):
        ...
        if sweep_voltage == -40:
            ...
            peak_neg_40mV = max_cd_peak_a
            cap_neg_40mV = capacitance
            ...
            if numpy_pandas == 'numpy':
                ...
                if max_cd_peak_250_indx[0] >= 5:
                    ...
                    max_cd_peak_250 = np.mean(max_cd_peak_250_array)
            current_density_neg_40mV_250 = max_cd_peak_250 / capacitance
            ...
            current_density_neg_40mV_500 = max_cd_peak_500 / capacitance
    ...
    plt.close('all')
    if current_density_neg_40mV_a != 'N/A' and current_density_neg_40mV_250 != 'N/A':
        current_density_ratio_250 = current_density_neg_40mV_250 / current_density_neg_40mV_a
        current_density_ratio_500 = current_density_neg_40mV_500 / current_density_neg_40mV_a
    else:
