...
def ssDeact_analyse_CD_neg_40mV_neg_110mV_peak_ratio(input_file, wellID, result_plots, num_sweeps, variant, sweep_length, total_sweeps, neg_50_amp_thresh, neg_120_amp_thresh):
    # TO DO:
    # Pass
    ...
    current_density_neg_40mV = 'N/A'
    current_density_neg_110mV = 'N/A'
    ...
    for sweep in range(1, (2*num_sweeps), 2):
        ...
        if sweep_voltage == -40:
            ...
            if numpy_pandas == 'numpy':
                ...
                if max_cd_peak < neg_50_amp_thresh*1e-12:
                    continue
                '''
                current_density_neg_40mV = max_cd_peak / capacitance
                peak_neg_40mV = max_cd_peak
        ...
        # -120mV
            ...
            if numpy_pandas == 'numpy':
                ...
                peak_neg_110mV = min_cd_peak
                cap_neg_110mV = capacitance
                current_density_neg_110mV = min_cd_peak / capacitance
    ...
    plt.close('all')
    if current_density_neg_40mV != 'N/A' and current_density_neg_110mV != 'N/A':
        #current_density_ratio = current_density_neg_120mV / current_density_neg_50mV

        if current_density_neg_110mV > -50: #pA/pF
            current_density_ratio = 'N/A'
        else:
            current_density_ratio = current_density_neg_40mV/ current_density_neg_110mV
    else:
        current_density_ratio = 'N/A'
    ...
    return [current_density_ratio, current_density_neg_40mV, current_density_neg_110mV]
